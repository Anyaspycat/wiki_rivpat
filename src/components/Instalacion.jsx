      ...
      pasosList: [
        {
          ...
          imagen: 'docs_rivpat/img_rivpat/02_Instalacion_Configuracion/A_Paso_1.png',
        },
        {
          numero: 2,
          descripcion: 'Se configura la memoria RAM con 4 GB y se asignan 2 núcleos de CPU.',
          imagen: 'docs_rivpat/img_rivpat/02_Instalacion_Configuracion/A_Paso_2.png',
        },
        {
          numero: 3,
          descripcion: 'Se define un disco duro virtual de 50 GB para la instalación del sistema operativo.',
          imagen: 'docs_rivpat/img_rivpat/02_Instalacion_Configuracion/A_Paso_3.png',
        },
        {
          numero: 4,
          descripcion: 'Se configura el adaptador de red en modo red interna, utilizando el nombre redlab.',
          imagen: 'docs_rivpat/img_rivpat/02_Instalacion_Configuracion/A_Paso_4.png',
        },
      ],
    },
    {
      ...
      pasosList: [
        {
          ...
          imagen: 'docs_rivpat/img_rivpat/02_Instalacion_Configuracion/A_Paso_11.png',
        },
        {
          numero: 12,
          descripcion: 'Se selecciona la opción para cambiar el nombre del equipo y se establece el nombre SRV-DC01.',
          imagen: 'docs_rivpat/img_rivpat/02_Instalacion_Configuracion/A_Paso_12.png',
        },
      ],
    },
    {
      ...
      pasosList: [
        {
          ...
          imagen: 'docs_rivpat/img_rivpat/02_Instalacion_Configuracion/A_Paso_18.png',
        },
        {
          numero: 19,
          descripcion:
            'Se verifica que el Firewall de Windows se encuentre activo para que posteriormente habilite puertos según servicios.',
          imagen: 'docs_rivpat/img_rivpat/02_Instalacion_Configuracion/A_Paso_19.png',
        },
      ],
    },
  ];
